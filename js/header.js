...
// Fechar as opções ao clicar fora do conteúdo
window.addEventListener('click', function (event) {
    var menuOptions = document.getElementById('menu-options');
    var perfilContainer = document.getElementById('perfil-container');
    
    if (event.target !== perfilContainer && event.target !== menuOptions) {
...
//     var menuOptions = document.getElementById('menu-options2');
...
// Close the notification menu if user clicks outside
window.addEventListener("click", function (event) {
    var notificationMenu = document.getElementById("notificationMenu");
    var notificationArea = document.querySelector(".notification-area");

    if (event.target !== notificationMenu && event.target !== notificationArea) {
        notificationMenu.style.display = "none";
        
    }
});

document.getElementById("sair-not").addEventListener("click", function () {
    var notificationMenu = document.getElementById("notificationMenu");
    var notificationArea = document.querySelector(".notification-area");
    var body = document.body;

    notificationMenu.classList.remove("open");
    notificationArea.classList.remove("open");
    body.classList.remove("notification-menu-open");
});
