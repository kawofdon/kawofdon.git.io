...
<body>
  ...
  <section class="edms" id="edms">
    <br>
    <br>
    
    <div class="content">
      <div class="title"><span>Sobre Nós</span></div>
      <div class="edms-details">
        
        <div class="left">
          <img src="../img/logo2-removebg-preview.png" alt="" />
        </div>
        <div class="right">
          <div class="topic">o que e a EDMS?</div>
          <h4>
            A EDMS e uma empresa de produção de materias eletronicos, que e cria soluções tecnológicas inovadoras ultilizando o lixo eletrônico, assim auxiliando para a preservação do meio ambiente e oferecendo produtos de alta qualidade.      </h4>
  ...
  <section class="services" id="services">
    <div class="content">
      ...
      <br>
      <br>
      <div class="title"><span>Missão,Visão e Valores</span></div>
      <div class="boxes">
        <div class="box">
          <div class="icon">
            <i class="fas fa-crosshairs"></i>
          </div>
          <div class="topic">MISSÃO</div>
          <p>
            A missão da EDMS é liderar a transformação sustentável 
            no setor de produtos eletrônicos, promovendo a inovação 
            e a conscientização ambiental. Buscamos criar soluções 
            tecnológicas inovadoras, utilizando lixos eletrônicos 
            como matéria-prima, contribuindo para a preservação do 
            meio ambiente e proporcionando produtos de alta qualidade 
            aos nossos clientes.
          </p>
        </div>
        <div class="box">
          ...
          <div class="topic">VISÃO</div>
          <p>
            Nossa visão é ser reconhecida como 
            uma empresa global pioneira na produção 
            de produtos eletrônicos sustentáveis. 
            Almejamos um futuro em que a indústria 
            tecnológica seja um agente positivo para 
            o meio ambiente, destacando-nos pela 
            excelência em design, funcionalidade e 
            responsabilidade ambiental. Buscamos inspirar 
            outras empresas a adotarem práticas sustentáveis, 
            contribuindo para um mundo mais verde e equitativo.
          </p>
        </div>
        <div class="box">
          <div class="icon">
          ...
          <div class="topic">VALORES</div>
          <p id="valores">
            1. <b>Sustentabilidade</b> 
  ...
  <div class="content">
    <div class="title"><span>Localização</span></div>
    <div class="text">
      
      <p>Avenida das Montanhas, 123
...
<div class="anchototal">
  <div class="row">
      <div class="column-12 google-maps">
        <iframe src="https://www.google.com/maps/embed?pb=!1m16!1m12!1m3!1d29997.396900119387!2d-43.96851617219161!3d-19.980181878119097!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!2m1!1sAvenida%20das%20Montanhas%2C%20123%20%20Belvedere%20Belo%20Horizonte%20-%20MG%20%20CEP%3A%2012345-678!5e0!3m2!1spt-BR!2sbr!4v1706633419455!5m2!1spt-BR!2sbr" width="100%" height="400" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
      </div>
  </div>
</div> 
