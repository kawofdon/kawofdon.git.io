...
<body> 
 ...
 -->
        ...
        <div class="separar">
            ...
            <br>
            <P>Dúvidas? Acesse os temas abaixo que a EDMS esclarece para você!</P>
            <br>
            <div class="faq">
                ...
                <div class="innerwrap">
                    ...
                    <section class="section2 clearfix">
                        <div class="col2 column1 first">
                            <img src='../img/Emails-bro-removebg-preview.png'></img>
                        </div>
                        <div class="col2 column2 last">
                            <div class="sec2innercont">
                                <div class="sec2addr">
                                    <br>
                                    <br>
                                    <h1>Ainda está com duvidas? Entre contato conosco!</h1>
                                    <br>
                                    <p><span class="collig">Endereço :</span>Avenida das Montanhas, 123


                                    <p><span class="collig">Telefone :</span> +31 976885083</p>
                                    <p><span class="collig">Email :</span> nexustech@gmail.com</p>
                                </div>
                                <br>
                            </div>
                            <div class="sec2contactform">
                                <form action="" class="id-form-faq">
                                    <div class="clearfix">
                                        <input class="col2 first" type="text" placeholder="Nome">
                                        <input class="col2 last" type="text" placeholder="Sobrenome">
                                    </div>
                                    <div class="clearfix">
                                        <input  class="col2 first" type="Email" placeholder="Email">
                                        <input class="col2 last" type="text" placeholder="Numero de Contato">
                                    </div>
                                    <div class="clearfix">
                                        <textarea name="textarea" id="" cols="30" rows="7" placeholder="Sua mensagem aqui..."></textarea>
                                    </div>
