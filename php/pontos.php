<?php
    ...
    //PARA RECONHECER O NOME DE USÚARIO COM A SESSÃO INICIADA
     //session_start();
    ...
    if(isset($_SESSION['nome_usuario'])) {
        ...
        $nomeUsuario = $_SESSION['nome_usuario']; // Obtém o nome do usuário da sessão
    ...
    try {
        ...
        //variável com valor do id do usuário logado na sessão
        $userId = $_SESSION["id_user"];

        $sql = $db->query("SELECT * FROM perfil WHERE id_user = '$userId'");
        if ($sql->rowCount() > 0)
        {
        ...
        {
            echo "Não existe usuário cadastrado com esse código";
            //echo $userId;
        }
        }
...
<head>
    ...
    <link rel="icon" type="image/png" href="../img/NEXUSTECH-RF.png">

    <link rel="stylesheet" href="../css/rodape.css">
    <link rel="stylesheet" href="../css/perfil.css">
    <link rel="stylesheet" href="../css/header.css">
    <link rel="stylesheet" href="../CSS/pontos.css">
    <link rel="stylesheet" href="../CSS/pontosResponsivo.css">
...
<header class="header" id="myHeader">
    ...
    <!-- <div class="pontos">
        ...
        <br><br><br><br>
        <center>
            <div class="card1" id="openPopupBtn" onclick="kabum()">
                <img src="../IMG/kabum-logo-0.png" alt="Logo Kabum" class="logos">
                <div class="barra">
                    <div id="progresso1">
        ...
        <br><br><br><br>
            <div class="card1" id="openPopupBtn"  onclick="terabyte()">
                <img src="../IMG/terabyte.png" alt="Logo Terabyte"   class="logos">
                <div class="barra">
                    <div id="progresso2">
            ...
            <div class="popup-content">
                    ...
                    <h2>Meu Pop-up</h2>
                    <p>Conteúdo do pop-up vai aqui.</p>
                </div>
            </div>


            <br><br><br><br>
            <div class="card1" id="openPopupBtn"  onclick="magalu()">
                <img src="../IMG/magalu-logo-0.png" alt="Logo Kabum" class="logos">
                <div class="barra">
                    <div id="progresso3">
    ...
    <div class="insuficiente">
          <h1>Você não possui pontos suficientes</h1>
          <div class="fechar_insuficiente">
            <img src="../IMG/cancel.png" alt="" onclick="fechar_insuficiente()">
        </div> 
    </div>     
    ...
    <div class="sucesso">
        ...
        <div class="fechar_insuficiente">
            <img src="../IMG/cancel.png" alt="" onclick="fechar_sucesso()">
        </div> 
    </div>
    ...
    <form class="confirm" name="cadastro" method ="post" action ="envio_dados.php">
        <h1>
            Você tem certeza que deseja resgatar?<input type="text" value ="" name="pontos" required id="send_point" >
            </h1>
        <!-- <button type="submit" value="Sim"> sim</button> -->
        <button type="button" onclick="resgatar()" class="enviar" >Sim</button>
        <button type="button" onclick="cancel_kabum()" class ="nao">Não</button>
